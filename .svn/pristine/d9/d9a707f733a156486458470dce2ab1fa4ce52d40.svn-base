...
bool cs6963::cMaterialBuilder::Build_derived( const char* i_fileName_source, const char* i_fileName_target ) const
{
	// For now effects don't get "built";
	// instead, copy the source material as-is to the target
