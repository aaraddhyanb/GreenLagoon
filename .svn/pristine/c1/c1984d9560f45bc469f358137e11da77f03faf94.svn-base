...
bool cs6963::cCubeMapsBuilder::Build_derived( const char* i_fileName_source, const char* i_fileName_target ) const
{
	// For now effects don't get "built";
	// instead, copy the source maps as-is to the target
