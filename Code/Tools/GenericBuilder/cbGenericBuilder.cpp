...
bool cs6963::cbGenericBuilder::Build( const int i_argumentCount, char** i_arguments ) const
{
...
void cs6963::cbGenericBuilder::FormatAndOutputErrorMessage( const std::string& i_errorMessage ) const
{
	std::cerr << GetToolName() << ": error: " << i_errorMessage << "\n";
}

std::string cs6963::cbGenericBuilder::GetLastWindowsError()
{
